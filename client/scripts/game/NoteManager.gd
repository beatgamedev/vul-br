...
func _process(delta):
	var song_time = sync_manager.current_time
	...
	for i in current_notes_size:
		...
		var time_difference = note.time - song_time
...
func _physics_process(delta):
	var song_time = sync_manager.current_time # sync_manager.physics_time
	var cursor_position = player.cursor_position
